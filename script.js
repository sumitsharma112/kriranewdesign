const reviews = [
    ...
    { name: "Md. Aijaz", product: "KPDEX", rating: 4, comment: "Good cough syrup. Khansi mein relief milta hai." },
    { name: "Bhavesh", product: "KRI-K27", rating: 5, comment: "Doctor ne recommend kiya tha. Excellent quality!" },
    { name: "Chetan", product: "UTI-LEU", rating: 5, comment: "Helped me recover quickly. Bahut satisfied hoon!" },
    { name: "Ashish", product: "Aciramol P", rating: 4, comment: "Reliable pain relief. Ghar mein hamesha rakhta hoon." },
    { name: "Vimal", product: "KRISURE", rating: 5, comment: "Immunity bahut improve hui hai. Great product!" },
